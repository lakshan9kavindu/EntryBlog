...
<body data-authenticated="<?php echo $currentUserId !== null ? 'true' : 'false'; ?>">
    ...
    <div class="middle"><div class="title"><h1><?php echo escapeOutput($title); ?></h1></div>
        <div class="some-btn"><div class="btn"><img src="assets/icons/like.png" alt="Like Icon"><p><?php echo escapeOutput($category); ?></p></div><div class="btn"><img src="assets/icons/like.png" alt="Like Icon"><p><?php echo $likeCount; ?> Likes</p></div><div class="btn"><img src="assets/icons/share.png" alt="Share Icon"><p><?php echo $followerCount; ?> Followers</p></div><div class="btn"><img src="assets/icons/save-icon.png" alt="Bookmark Icon"><p><?php echo $saveCount; ?> Saved</p></div></div>
    </div></div>
