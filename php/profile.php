...
<body data-authenticated="true">
    ...
    <section class="first-card">
        <div class="pro-card">
            ...
            <p>Member account</p>
            <div class="button">
                <a href="#"><img src="../assets/icons/Scroll Down.png" alt="followers">
            ...
            <div class="button-2">
                <a href="article-upload.php">
                    <h3>New article</h3><img src="../assets/icons/Vector-5.png" alt="Add article">
                </a>
                <a href="logout.php">
                    <h3>Log out</h3><img src="../assets/icons/Scroll Down.png" alt="Log out">
                </a>
            </div>
        </div>
